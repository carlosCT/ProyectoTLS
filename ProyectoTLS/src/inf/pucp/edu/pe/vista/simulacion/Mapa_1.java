 ...
 * @author juancarlos
 */
public class Mapa_1 extends javax.swing.JPanel {
       ...
       paint(g);
        ...
        Thread actualizarSemaforos = new Thread(){
            ...
            public void run(){
                ...
                while(Simulador_1.run){
                    while(Simulador_1.seguir){
...
//                          
           ...
           //                 int cant= listaCruces1.size()+listaCruces2.size()+listaCruces3.size()+listaCruces4.size()+listaCruces5.size()+listaCruces6.size()+listaCruces7.size()+listaCruces8.size()+listaCruces9.size()+listaCruces10.size()+listaCruces11.size()+listaCruces12.size()+listaCruces13.size()+listaCruces14.size()+listaCruces15.size()+listaCruces16.size();
             int cant=listaCruces1.size();
                           Simulador_1.lblCantSemaforos2.setText("#SemaforosZona: "+cant);
            ...
            while(Simulador_1.run){
                while(Simulador_1.seguir){
                  //  escala=400/factor;
                   ...
                   Simulador_1.lblCantVehiculos2.setText("#VehiculosZona: "+ listaVehiculos.size());
...
//   
     ...
     private void paintAll1Semaphore(Graphics g) {
       ...
       public void paintSemaphore(Graphics g, Cruce semaforo){
           ...
           }else if (Simulador_1.nivelZoom==9){
           ...
           }else if (Simulador_1.nivelZoom==8){
           ...
           }else if (Simulador_1.nivelZoom==7){
           ...
           }else if (Simulador_1.nivelZoom==6){
           ...
           }else if (Simulador_1.nivelZoom==5){
           ...
           }else if (Simulador_1.nivelZoom==4){
           ...
           }else if (Simulador_1.nivelZoom==3){
           ...
           }else if (Simulador_1.nivelZoom==2){
           ...
           }else if (Simulador_1.nivelZoom==1){
           ...
           }else if (Simulador_1.nivelZoom==11){
           ...
           }else if (Simulador_1.nivelZoom==12){
           ...
           }else if (Simulador_1.nivelZoom==13){
           ...
           }else if (Simulador_1.nivelZoom==14){
           ...
           }else if (Simulador_1.nivelZoom==15){
